# Wortschatz – Lektion 4: Arbeitswelt

## Stellensuche (Job Search)

| Deutsch | Artikel | Englisch |
|---------|---------|----------|
| Reservierung | die | reservation |
| Bestätigung | die | confirmation |
| Vertrag | der | contract |
| Zettel | der | note / slip of paper |
| Kaufhaus | das | department store |
| Aushang | der | notice / posting |
| Plattform | die | platform / website |
| Forum | das | forum |
| Agentur | die | agency |
...
| Lebenslauf | der | CV / résumé |
| Vorstellung | die | introduction / presentation |
| Vorbereitung | die | preparation |
| Vorstellungsgespräch | das | job interview |
| Betriebsrat | der | works council |
| Betrieb | der | company / operation |
| Gewerkschaft | die | trade union |
| Versammlung | die | assembly / meeting |
| Bericht | der | report |
| Recht | das | right / law |
| Entlassung | die | dismissal / redundancy |
| Vorschrift | die | regulation / rule |
| Beratung | die | advice / consultation |
| Förderung | die | funding / support |

## Im Betrieb (At the Workplace)

| Deutsch | Artikel | Englisch |
|---------|---------|----------|
| Lohn | der | wage |
| Überstunde | die | overtime |
| Nationalfeiertag | der | national holiday |
| Ahnung | die | idea / knowledge |
| Regel | die | rule |
| Industrie | die | industry |
