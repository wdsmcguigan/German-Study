# Wortschatz – Lektion 13: Auf der Bank

## Bankgeschäfte (Banking)

| Deutsch | Artikel | Englisch |
|---------|---------|----------|
| Konto | das | bank account |
| EC-Karte | die | debit card |
| Kreditkarte | die | credit card |
| Geldautomat | der | ATM / cashpoint |
| Kontoauszug | der | bank statement |
| Zinsen (Pl.) | die | interest (rate) |
| Betrag | der | amount |
| Summe | die | sum / total |
...
| Öl | das | oil |
| Bremse | die | brake |
| Inspektion | die | inspection / service |
| Werkstatt | die | garage / workshop |
| Polizei | die | police |
| Laune | die | mood |
| Menü | das | menu |
| Ober | der | waiter (formal) |
