# Wortschatz – Lektion 2: Zu Hause

## Im Haus / Im Gebäude (In the Building)

| Deutsch | Artikel | Englisch |
|---------|---------|----------|
| Aufzug | der | lift / elevator |
| Treppe | die | stairs |
| Briefkasten | der | letterbox / mailbox |
| Einfahrt | die | driveway / entrance |
| Hof | der | courtyard |
| Keller | der | cellar / basement |
| Kinderwagen | der | pram / pushchair |
| Fahrrad | das | bicycle |

## Wohnungsregeln & Alltag

| Deutsch | Artikel | Englisch |
|---------|---------|----------|
| Energie | die | energy |
| Decke | die | ceiling / blanket |
| Wand | die | wall |
| Licht | das | light |
| Ruhe | die | quiet / peace |
| Schild | das | sign |
| Stift | der | pen |
| Kugelschreiber | der | ballpoint pen |
| Schloss | das | lock |
| Schlüssel | der | key |
...
| Deutsch | Englisch |
|---------|----------|
| stecken | to stick / to be stuck in |
| stehen (hat gestanden) | to stand / be placed |
| legen | to lay / place (flat) |
...
| Deutsch | Artikel | Englisch |
|---------|---------|----------|
| Müll | der | rubbish / waste |
| Abfall | der | waste / refuse |
| Mülltonne | die | bin / dustbin |
| Müllcontainer | der | large waste bin |
| Müllwagen | der | bin lorry |
| Plastik | das | plastic |
...
| Verständnis | das | understanding |
| Mitteilung | die | notice / message |
| Lösung | die | solution |
| Frage | die | question |
| Bitte | die | request |
