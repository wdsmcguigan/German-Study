...
| Schloss | das | castle |
| Dom | der | cathedral |
| Sehenswürdigkeit | die | sight / attraction |
...
| Deutsch | Artikel | Englisch |
|---------|---------|----------|
| Pension | die | guesthouse |
| Hotel | das | hotel |
| Einzelzimmer | das | single room |
| Doppelzimmer | das | double room |
| Camping | das | camping |
| Zelt | das | tent |
| WC | das | toilet |
| Halbpension | die | half board |
| Dusche | die | shower |
| Bad | das | bathroom |
| Blick | der | view |
| Jugendherberge | die | youth hostel |
| Übernachtung | die | overnight stay |
| historisch | – | historic |
| zahlreich | – | numerous |
| romantisch | – | romantic |
...
## Reise buchen (Booking a Trip)

| Deutsch | Artikel | Englisch |
|---------|---------|----------|
| Reisebüro | das | travel agency |
| Reisepass | der | passport |
| Ausweis | der | ID card |
| Spezialist / Spezialistin | der / die | specialist |
| Angestellte / Angestellter | die / der | employee |
| Verbindung | die | connection |
| Führung | die | guided tour |
| Abstrakt | der | abstract / section |
...
| Deutsch | Englisch |
|---------|----------|
| eine Wanderung machen | to go hiking |
| Sehenswürdigkeiten besichtigen | to visit sights |
| eine Ausstellung ansehen | to see an exhibition |
