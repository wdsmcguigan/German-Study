# Wortschatz – Lektion 7: Kinder und Schule
...
| Grundschule | die | Grundschulen | primary / elementary school |
| Klasse | die | Klassen | class / classroom |
| Unterricht | der | – | lesson / class |
| Lehrer | der | Lehrer | teacher (m) |
| Lehrerin | die | Lehrerinnen | teacher (f) |
| Schüler | der | Schüler | pupil (m) |
| Schülerin | die | Schülerinnen | pupil (f) |
| Mädchen | das | Mädchen | girl |
| Junge | der | Jungen | boy |
| Test | der | Tests | test |
| Diktat | das | Diktate | dictation |
| Übung | die | Übungen | exercise |
| Brief | der | Briefe | letter |
| Buch | das | Bücher | book |
| Text | der | Texte | text |
| Lied | das | Lieder | song |
| Mathematik / Mathe | die | – | mathematics |
| Frühstück | das | Frühstücke | breakfast |

## Freizeitaktivitäten (Leisure Activities – full list)
...
|---------|---------|--------|----------|
| Team | das | Teams | team |
| Ausflug | der | Ausflüge | trip |
| Schwimmbad | das | Schwimmbäder | swimming pool |
| Eintritt | der | – | admission / entry |
